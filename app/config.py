...
class Settings:
    ...
    vk_user_token: str = os.getenv("VK_USER_TOKEN", "")  # ← ДОБАВЛЕНО
    vk_group_id: int = int(os.getenv("VK_GROUP_ID", "0"))
    operator_user_ids: list[int] = field(default_factory=lambda: _csv_ints(os.getenv("OPERATOR_USER_IDS"))) # <-- ИЗМЕНЕНО
